...
The machine-checked snapshot currently partitions all 3,043 declarations into
305 Stable consumer declarations, 2,705 Provisionally Stable consumer
...
- `APIDefinition`, `AnyEncodable`, `AnyRequestExecutionPolicy`,
  ...
  `URLQueryKeyEncodingStrategy`, and
  `W3CTraceContext`.
...
- Playback metrics: `HLSPlaybackMetricContext`, `HLSPlaybackMetricEvent`,
  ...
  `HLSPlaybackRenditionSelectionMetric`, `HLSPlaybackStartupMetric`,
  ...
  chronological request details. Detailed switch metrics expose only bitrate
  values and validated stable rendition IDs, never playlist URLs.
