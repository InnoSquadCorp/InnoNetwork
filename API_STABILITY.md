...
The machine-checked snapshot currently partitions all 2,377 declarations into
305 Stable consumer declarations, 2,039 Provisionally Stable consumer
...
- `HLSLiveConfiguration`, `HLSLiveEncryptionKeyPreloading`, `HLSLiveError`,
  ...
  `HLSLiveDVRPartPack`, `HLSLiveDVRProgress`,
  `HLSLiveDVRReceipt`, `HLSLiveDVRRecorder`, `HLSLiveDVRRenditionPack`,
