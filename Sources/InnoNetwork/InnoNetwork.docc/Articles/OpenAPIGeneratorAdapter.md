...
the SPI and pin an exact released tag because this hook is not part of the
public contract. Do not ship a moving branch dependency in production; SPI
remains outside SemVer guarantees.
