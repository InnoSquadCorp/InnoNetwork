...
| `InnoNetworkHLS` | 634 |
| `InnoNetworkHLSLive` | 194 |
| `InnoNetworkHLSAVFoundation` | 361 |
...
| Provisionally Stable consumer API | 2,059 |
| `@_spi(GeneratedClientSupport)` | 33 |
| **Total** | **2,397** |

## Why this matters

For a single-maintainer client-side Swift networking library, 2,397 public
